...
[<AutoOpen>]
module Railway =
    type Result<'TOk, 'TErr> = Choice<'TOk, 'TErr>
    ...
    let bind successTrack (input : Attempt<_, _>) = 
...
let nupkgPaketPath = @"E:\github\dotnet-mergenupkg\examples\paket\Chessie.0.4.0.nupkg"
let nupkgNetcorePath = @"E:\github\dotnet-mergenupkg\examples\cli\Chessie.0.4.0.nupkg"
